...
namespace GGJ
{
    ...
    public class PickableBubble : CustomBehaviour
    {
        ...
        [Header("Vitesse de déplacement horizontales des bulles")]
        [SerializeField] private float _minLateralSpeed = 0f;
        [SerializeField] private float _maxLateralSpeed = 1f;
        [Header("ça tu touche je t'atomise")]
        [SerializeField] private float _bubbleDespawnHeight = 10.0f;
        
        private float _currentMoveSpeed = 2.0f; // Vitesse de montée de la bulle
        ...
        {
            // Permet de changer la direction de la bulle (utile si on veut descendre ou bouger latéralement)
